...
;(function($){
	...
	$(document).ready(function() {
		...
		var obj = $('#index_slider ul').bxSlider({ // 自動再生に必須
			infiniteLoop: true,
			mode: 'fade',
			auto: true,
			autoStart: true,
		...
		if (window.matchMedia('screen and (min-width:769px)').matches) {
			...
			var obj = $('#seat_list ul ul').bxSlider({ // 自動再生に必須
				mode: 'fade',
				pager: true,
			});
		...
		if (window.matchMedia('screen and (min-width:1367px)').matches) {
			...
			var obj = $('#campaign_list ul').bxSlider({
				controls: true,
				minSlides: 6,
				maxSlides: 6,
				slideWidth: 236,
		...
		if (window.matchMedia('screen and (min-width:769px)').matches) {
			...
			var obj = $('#index #column_list ul').bxSlider({
				minSlides: 4,
				maxSlides: 4,
				slideWidth: 277.5,
				slideMargin: 30,
			...
			var obj = $('#timetable #column_list ul').bxSlider({
				minSlides: 4,
				maxSlides: 4,
				slideWidth: 245,
				slideMargin: 20,
		...
		} else if (window.matchMedia('screen and (min-width:360px)').matches) {
			
			var obj = $('#index #column_list ul , #timetable #column_list ul').bxSlider({
				pager: true,
				minSlides: 2,
				maxSlides: 2,
				slideWidth: 354,
